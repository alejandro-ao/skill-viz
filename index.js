...
@media (max-width: 980px){body{height:100vh;overflow:hidden;display:flex;flex-direction:column}.mobile-app-title{display:block;flex:0 0 auto;z-index:40;background:var(--surface);border-bottom:1px solid var(--line);padding:14px 18px}.mobile-app-title h1{margin:0}.mobile-app-title .subtitle{margin-top:4px}.app{display:flex;flex-direction:column;flex:1;min-height:0;height:auto;overflow:hidden}.collapse-btn{display:inline-flex;align-items:center;justify-content:center}.skills-sidebar,.toc-sidebar{flex:0 0 auto;max-height:34vh;border-right:0;border-bottom:1px solid var(--line);padding:14px 18px;overflow:auto}.toc-sidebar{background:var(--surface)}.skills-sidebar.collapsed,.toc-sidebar.collapsed{max-height:none;overflow:hidden}.skills-sidebar.collapsed .sidebar-body,.toc-sidebar.collapsed #toc{display:none}.skills-sidebar .sidebar-head{display:none}.theme-float{right:14px;bottom:14px}.theme-float.icon-btn{width:42px;height:42px} main{flex:1;min-height:0;padding:18px;overflow:auto}.card{padding:22px;border-radius:4px}}
