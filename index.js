...
.app{display:grid;grid-template-columns:320px 280px 1fr;height:100vh}.app.skills-collapsed{grid-template-columns:44px 280px 1fr}.app.toc-collapsed{grid-template-columns:320px 44px 1fr}.app.skills-collapsed.toc-collapsed{grid-template-columns:44px 44px 1fr} aside{background:var(--surface);border-right:1px solid var(--line);padding:20px;overflow:auto} main{overflow:auto;padding:32px}.skills-sidebar.collapsed,.toc-sidebar.collapsed{padding:12px 8px;overflow:hidden}.skills-sidebar.collapsed .sidebar-body,.toc-sidebar.collapsed #toc{display:none}.collapse-row{display:flex;align-items:center;justify-content:space-between;gap:8px}.collapse-btn{border:1px solid var(--line);background:var(--surface);color:var(--muted);border-radius:4px;width:28px;height:28px;cursor:pointer}.collapse-btn:hover{background:var(--surface-2);color:var(--text)}.collapsed-label{display:none;writing-mode:vertical-rl;transform:rotate(180deg);font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--muted);margin:12px auto}.collapsed .collapsed-label{display:block}.toc-sidebar{background:var(--bg);padding:16px}.toc-title{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--muted);margin:2px 0 12px}.toc-section{border-bottom:1px solid var(--line);padding:6px 0}.toc-section summary{cursor:pointer;list-style:none;display:flex;align-items:center;justify-content:space-between;padding:8px 0;font-size:13px;font-weight:700}.toc-section summary::-webkit-details-marker{display:none}.toc-section summary::after{content:'+';color:var(--muted);font-weight:500}.toc-section[open] summary::after{content:'−'}.toc-link{display:block;width:100%;border:0;background:transparent;color:var(--muted);text-align:left;padding:6px 8px;border-radius:4px;cursor:pointer;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.toc-link:hover{background:var(--surface-2);color:var(--text)}.toc-link.lvl-2{padding-left:18px}.toc-link.lvl-3{padding-left:28px}.toc-link.lvl-4,.toc-link.lvl-5,.toc-link.lvl-6{padding-left:38px}
...
.empty{text-align:center;color:var(--muted);padding:80px 20px} .sources{font-size:12px;color:var(--muted);padding-left:18px;line-height:1.6} .sources li.hidden{display:none}.count{color:var(--muted);font-size:12px;margin-top:12px}.agent-filter{margin:18px 0 4px}.agent-select{width:100%;padding:8px 10px;border:1px solid var(--line);border-radius:4px;background:var(--surface);color:var(--text);font:inherit;font-size:13px;outline:none}.agent-select:focus{border-color:var(--brand);box-shadow:0 0 0 3px var(--ring)}
@media (max-width: 980px){.app,.app.skills-collapsed,.app.toc-collapsed,.app.skills-collapsed.toc-collapsed{grid-template-columns:1fr}.skills-sidebar,.toc-sidebar{max-height:42vh;border-right:0;border-bottom:1px solid var(--line)}.skills-sidebar.collapsed,.toc-sidebar.collapsed{max-height:44px}.skills-sidebar.collapsed .collapsed-label,.toc-sidebar.collapsed .collapsed-label{display:none} main{padding:18px}.card{padding:22px;border-radius:4px}}
</style></head><body><div class="app" id="app"><aside class="skills-sidebar" id="skills-sidebar"><div class="collapse-row"><div class="sidebar-head"><div><h1>Skill Visualizer</h1><div class="subtitle">Standalone dashboard for workspace and global agent skills.</div></div><button id="theme-toggle" class="icon-btn" type="button" aria-label="Toggle theme">◐</button></div><button id="skills-toggle" class="collapse-btn" type="button" aria-label="Toggle skills sidebar">‹</button></div><div class="collapsed-label">Skills</div><div class="sidebar-body"><div class="agent-filter"><div class="toc-title">Agents</div><div id="agent-list"></div></div><input id="q" class="search" placeholder="Search skills, scripts, references…"><div id="list"></div><div class="count" id="count"></div><h3>Checked sources</h3><ul class="sources" id="sources">${sourcesHtml}</ul></div></aside><aside class="toc-sidebar" id="toc-sidebar"><div class="collapse-row"><div class="toc-title">Contents</div><button id="toc-toggle" class="collapse-btn" type="button" aria-label="Toggle contents sidebar">‹</button></div><div class="collapsed-label">Contents</div><div id="toc"></div></aside><main id="main"><div id="detail" class="card"></div></main></div>
