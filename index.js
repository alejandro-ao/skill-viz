...
@media (max-width: 980px){body{overflow:auto}.mobile-app-title{display:block;position:sticky;top:0;z-index:40;background:var(--surface);border-bottom:1px solid var(--line);padding:14px 18px}.mobile-app-title h1{margin:0}.mobile-app-title .subtitle{margin-top:4px}.app{display:block;height:auto;overflow:visible}.collapse-btn{display:inline-flex;align-items:center;justify-content:center}.skills-sidebar,.toc-sidebar{position:sticky;z-index:35;max-height:42vh;border-right:0;border-bottom:1px solid var(--line);padding:14px 18px}.skills-sidebar{top:73px}.toc-sidebar{top:73px;background:var(--surface)}.skills-sidebar.collapsed,.toc-sidebar.collapsed{max-height:none}.skills-sidebar.collapsed .sidebar-body,.toc-sidebar.collapsed #toc{display:none}.skills-sidebar .sidebar-head{display:none}.theme-float{right:14px;bottom:14px}.theme-float.icon-btn{width:42px;height:42px} main{padding:18px;overflow:visible}.card{padding:22px;border-radius:4px}}
</style></head><body><button id="theme-toggle" class="icon-btn theme-float" type="button" aria-label="Toggle theme">◐</button><div class="mobile-app-title"><h1>Skill Visualizer</h1><div class="subtitle">Standalone dashboard for workspace and global agent skills.</div></div><div class="app" id="app"><aside class="skills-sidebar" id="skills-sidebar"><div class="collapse-row"><div><div class="sidebar-head"><h1>Skill Visualizer</h1><div class="subtitle">Standalone dashboard for workspace and global agent skills.</div></div><div class="toc-title">Available Skills</div></div><button id="skills-toggle" class="collapse-btn" type="button" aria-label="Toggle skills sidebar">−</button></div><div class="sidebar-body"><div class="agent-filter"><div class="toc-title">Agents</div><div id="agent-list"></div></div><input id="q" class="search" placeholder="Search skills, scripts, references…"><div id="list"></div><div class="count" id="count"></div><h3>Checked sources</h3><ul class="sources" id="sources">${sourcesHtml}</ul></div></aside><aside class="toc-sidebar" id="toc-sidebar"><div class="collapse-row"><div class="toc-title">Contents</div><button id="toc-toggle" class="collapse-btn" type="button" aria-label="Toggle contents sidebar">−</button></div><div id="toc"></div></aside><main id="main"><div id="detail" class="card"></div></main></div>
